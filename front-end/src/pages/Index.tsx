            ...
            <div className="container mx-auto max-w-5xl space-y-8">
              <div className="space-y-6 text-center">
                ...
                <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
                  Create relay addresses for free up to 20 that forward to your inbox. When the
                  spam starts, just turn them off. Your real email never gets exposed.
                </p>
              </div>
          ...
          <section className="bg-muted/30 px-4 py-16">
            <div className="container mx-auto max-w-5xl">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-3">Two Steps to a Spam-Free Life</h2>
              </div>
              ...
              <div className="grid gap-12 md:grid-cols-2">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div>
                      <h3 className="text-xl font-semibold mb-2">Step 2: Receive Emails Seamlessly</h3>
                      <p className="text-muted-foreground">
            ...
            <div className="container mx-auto max-w-3xl">
              ...
              <div className="p-8 rounded-lg border bg-card text-center space-y-4">
                <p className="text-lg text-muted-foreground">
                  All features are available for <span className="font-bold text-[#895BF5]">free</span> during the beta period.
                </p>
